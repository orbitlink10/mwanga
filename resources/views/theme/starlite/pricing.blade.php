...
@section('title', 'Starlink Kenya Price')
@section('meta_description', 'See current Starlink Kenya kit prices, monthly subscriptions, and setup guidance from Starlite Internet Kenya.')
@section('canonical', url('/starlink-kenya-price'))
@section('main')
