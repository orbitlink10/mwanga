...
@php
    $pageNumber = method_exists($products, 'currentPage') ? $products->currentPage() : 1;
@endphp
@section('title', $pageNumber > 1 ? 'Products Listing - Page ' . $pageNumber : 'Products Listing')
@section('meta_description', $pageNumber > 1 ? 'Browse Starlink kits, routers, mounts, and accessories in Kenya. Page ' . $pageNumber . ' of our product catalog.' : 'Browse Starlink kits, routers, mounts, and accessories in Kenya with trusted local support and delivery.')
@section('canonical', $pageNumber > 1 ? route('product', ['page' => $pageNumber]) : route('product'))
