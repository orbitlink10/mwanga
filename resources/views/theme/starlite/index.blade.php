...
@section('title', get_option('hero_header_title', 'Starlite Internet Kenya'))
@section('meta_description', get_option('hero_header_description', 'Order genuine Starlink kits with professional installation across Kenya.'))
...
@section('main')
@php
  $heroTitle          = get_option('hero_header_title', 'Starlite Internet Kenya: Official Starlink Reseller & Installer');
  $heroDesc           = get_option('hero_header_description', 'Order genuine Starlink kits with professional installation across Kenya for homes, businesses, schools, and field teams.');
  $heroImage          = get_option('hero_image', asset('assets/images/starlink_1.webp'));
  $cachedProducts     = $products ?? collect();
  $cachedMedias2      = $medias2 ?? collect();
  $cachedTestimonials = $testimonials ?? collect();
  $cachedServices     = $services ?? collect();
@endphp
    ...
    <div class="row align-items-center py-4">
      <div class="col-md-6 text-md-start text-center mb-4 mb-md-0">
        ...
        <h1 class="display-4 fw-bold text-dark mb-3">
          {{ strip_tags((string) $heroTitle) }} <span class="text-gradient">Kenya</span>
        </h1>
        <p class="lead text-secondary mb-4">{{ strip_tags((string) $heroDesc) }}</p>
      ...
      <div class="col-md-6 text-center">
        <img src="{{ $heroImage }}" alt="Starlite Internet Kenya Hero"
        ...
        <div class="col-sm-6 col-md-4 d-flex">
          <div class="card h-100 border-0 shadow-sm">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <p class="card-text text-muted flex-grow-1">{{ strip_tags((string) ($service->meta_description ?? '')) }}</p>
...
<!--=== About Starlite Internet Kenya (static) ===-->
<section id="about-starlite" class="section-py bg-white">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="card border-0 shadow-sm rounded-4">
          <div class="card-body p-5">
            <h2 class="fw-bold mb-4">About Starlite Internet Kenya</h2>
            <p>
              At <strong>Starlite Internet Kenya</strong>, we're on a mission to connect every corner of the country with reliable,
            ...
            <p>
              Whether you're in Nairobi's CBD or a remote homestead in Turkana, <strong>Starlite Internet Kenya</strong> brings the
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 position-relative">
                    ...
                    <div class="card-body p-5 description-frame">
                        @php
                            $homepageContent = trim((string) ($homepageDescriptionHtml ?? ''));
                            if ($homepageContent === '') {
                                $homepageContent = str_replace(
                                    ['â€”', 'â€“', 'â€™', 'Spacelink Kenya', 'SpacelinkKenya.co.ke'],
                                    ['-', '-', "'", 'Starlite Internet Kenya', 'starliteinternetkenya.co.ke'],
                                    (string) get_option('homepage_description')
                                );
                            }
                        @endphp
                        {!! $homepageContent !!}
