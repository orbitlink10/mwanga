...
@section('title', 'Contact ' . get_option('site_name'))
@section('meta_description', 'Contact Starlite Internet Kenya for Starlink kits, pricing, and installation support across Kenya.')
@section('main')
            ...
            <div class="col-lg-6">
                <div class="contact-page__left">
                    <div class="section-title text-left mb-4">
                        ...
                        <h1 class="section-title__title">Ready to get in touch with Starlink Kenya</h1>
                    </div>
