...
@php
    $postMetaDescription = \Illuminate\Support\Str::limit(
        strip_tags((string) ($post->meta_description ?: $post->description ?: $post->title)),
        160,
        ''
    );
@endphp
...
@section('twitter_description', $postMetaDescription)
...
<section class="py-5" id="homepage-description">
    <div class="container">
        {!! trim((string) ($postBodyHtml ?? '')) !== '' ? $postBodyHtml : $post->description !!}
    </div>
</section>
