...
@php
    $productMetaDescription = \Illuminate\Support\Str::limit(
        strip_tags((string) ($product->meta_description ?: $product->description ?: $product->name)),
        160,
        ''
    );
@endphp
...
@section('og_description', $productMetaDescription)
...
@section('twitter_description', $productMetaDescription)
                    ...
                    <div class="detail-extralink">
                        <div class="product-extra-link2">
                            ...
                            @endif
                                        ...
                                        @include('theme.starlite.modals.notify')
                                        @include('theme.starlite.modals.quote')
                        </div>
                    </div>
                ...
                <div class="tab-pane fade show active" id="Description">
                    <div class="container">
                        <div id="homepage-description">
                            {!! trim((string) ($productDescriptionHtml ?? '')) !== '' ? $productDescriptionHtml : $product->description !!}
                        </div>
                    </div>
                </div>
            </div>
