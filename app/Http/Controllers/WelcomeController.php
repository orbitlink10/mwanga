...
$homepageDescriptionHtml = str_replace(
    ["\u{2019}", 'Spacelink Kenya', 'SpacelinkKenya.co.ke'],
    ["'", 'Starlite Internet Kenya', 'starliteinternetkenya.co.ke'],
    $homepageDescriptionHtml
);
  ...
  public function showProductCategory($slug)
{
    ...
    public function faq(){
        $faqHtml = $this->sanitizeRichTextForSeo((string) get_option('faq', 'Find answers to common questions about Starlink kits, installation, billing, and support.'));
        return view('theme.'.get_option('theme').'.faq', compact('faqHtml'));
    }
    

        public function terms(){
        $termsHtml = $this->sanitizeRichTextForSeo((string) get_option('terms', 'Terms and conditions for Starlite Internet Kenya services.'));
    ...
    public function MpesaRes(Request $request)
{
    ...
    public function sitemapPages()
    {
        ...
        $staticPages = collect([
            ...
            ['path' => '/starlink-kenya-price', 'changefreq' => 'weekly', 'priority' => '0.78'],
            ['path' => '/starlink-rental', 'changefreq' => 'monthly', 'priority' => '0.55'],
